...
<main class="main-content">
            ...
            <div class="page-header">
                ...
                <!-- Standardized Notification Bell -->
                <div class="notification-container">
                    <button id="notification-button" class="notification-btn">
                        <i class="fas fa-bell"></i>
                        <?php if ($unreadNotifications > 0): ?>
                        <span id="notification-badge" class="notification-badge"><?php echo $unreadNotifications; ?></span>
                        <?php endif; ?>
                    </button>
                    <div id="notification-dropdown" class="notification-dropdown">
                        <div class="notification-header">
                            <h3><i class="fas fa-bell"></i> <?php echo ui_text('notification.header'); ?></h3>
                            <button id="mark-all-read"><?php echo ui_text('notification.mark_all'); ?></button>
                        </div>
                        <div id="notification-list" class="notification-list">
                            ...
                            <?php else: ?>
                                ...
                                <div class="notification-item <?php echo !$notif['is_read'] ? 'unread' : ''; ?>" data-ticket-id="<?php echo $notif['ticket_id']; ?>" data-notif-id="<?php echo $notif['notif_id']; ?>">
                                    <div class="notification-header">
                                        <span class="notification-title"><?php echo htmlspecialchars($notif['ticket_number']); ?></span>
                                    </div>
                                    <div class="notification-message"><?php echo htmlspecialchars($notif['message']); ?></div>
                                    <div class="notification-meta">
                                        <span><?php echo htmlspecialchars($notif['triggered_by_name'] ?? 'ระบบ'); ?></span>
                                    </div>
                                </div>
                                <?php endforeach; ?>
                            <?php endif; ?>
...
// ปุ่ม mark all read - ฟังก์ชันทำเครื่องหมายอ่านการแจ้งเตือนทั้งหมดของ user ปัจจุบัน\n// ทำเครื่องหมายอ่าน + ลบ badge + ลบ highlight unread items + แสดง toast สำเร็จ
...
// Mark notification as read and view ticket (mark as read and redirect to ticket)
