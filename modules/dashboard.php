...
// Get notifications เธเธฒเธเธฃเธฐเธเธเนเธซเธกเน (เธฃเธญเธเธฃเธฑเธเธ—เธฑเนเธ new_ticket เนเธฅเธฐ new_comment)
...
<main class="main-content">
                ...
                <div class="notification-wrapper">
                    ...
                    <div class="notification-dropdown" id="notificationDropdown">
                        <div class="notification-header" style="display:flex; justify-content:space-between; align-items:center;">
                            <h3><i class="fas fa-bell"></i> <?php echo ui_text('notification.title'); ?></h3>
                            <button 
                        ...
                        <div class="notification-list">
                            ...
                            <div class="notification-empty">
                                ...
                                <p><?php echo ui_text('notification.empty'); ?></p>
                            </div>
                            <?php else: ?>
                                <?php foreach ($notifications as $notif): 
                                    $isUnread = !$notif['is_read'];
                                    $icon = $notif['type'] === 'new_comment' ? '๐’ฌ' : '๐ซ';
                                    $time_diff = time() - strtotime($notif['created_at']);
                                    if      ($time_diff < 60)    $timeText = 'เน€เธกเธทเนเธญเธชเธฑเธเธเธฃเธนเน';
                                    elseif  ($time_diff < 3600)  $timeText = floor($time_diff / 60) . ' เธเธฒเธ—เธตเธ—เธตเนเนเธฅเนเธง';
                                    elseif  ($time_diff < 86400) $timeText = floor($time_diff / 3600) . ' เธเธฑเนเธงเนเธกเธเธ—เธตเนเนเธฅเนเธง';
                                    else                         $timeText = floor($time_diff / 86400) . ' เธงเธฑเธเธ—เธตเนเนเธฅเนเธง';
                                ?>
                                <div class="notification-item <?php echo $isUnread ? 'unread' : ''; ?>" 
                                    ...
                                    <div class="notification-title">
                                        ...
                                        <?php if ($isUnread): ?>
                                        <span style="font-size:0.75em; color:#e53e3e; font-weight:700; margin-left:6px;">โ— NEW</span>
                                        <?php endif; ?>
                                    </div>
                ...
                <div class="section-header">
                    <div>
                        <h2 class="section-title">
                            <i class="fas fa-boxes"></i> IT Assets เธ•เธฒเธกเธเธฃเธฐเน€เธ เธ—
                        </h2>
                        <p class="section-subtitle">เธเธฃเธฐเน€เธ เธ—เธชเธดเธเธ—เธฃเธฑเธเธขเนและสถิติเครือข่ายทรัพย์สิน</p>
                    </div>
                </div>
                <div class="section-body">
                    <?php if (!empty($assetTypes)): ?>
                        <div class="section-subtitle">เธเธฃเธฐเน€เธ เธ—เธชเธดเธเธ—เธฃเธฑเธเธขเน</div>
                    ...
                    <?php else: ?>
                        <div class="empty-state">
                            ...
                            <h3>ยังไม่มีข้อมูลทรัพย์สิน</h3>
                            <p>บันทึกทรัพย์สินเพื่อให้ข้อมูลในส่วนนี้แสดงสถิติที่ชัดเจน</p>
                        </div>
                    <?php endif; ?>
                </div>
            </section>
            ...
            <section class="section">
                <div class="section-header">
                    <div>
                        <h2 class="section-title">
                            <i class="fas fa-ticket-alt"></i> IT Tickets เธ•เธฒเธกเธซเธกเธงเธ”เธซเธกเธนเน
                        </h2>
                        <p class="section-subtitle">ติดตามหมวดหมู่ตั๋วเพื่อวางแผนกำลังคนและ SLA</p>
                    </div>
                </div>
                <div class="section-body">
                    ...
                    <?php else: ?>
                        <div class="empty-state">
                            ...
                            <h3>ยังไม่มีหมวดหมู่ตั๋ว</h3>
                            <p>บันทึก Ticket เพิ่มเติมเพื่อให้แผนภูมิหมวดหมู่แสดงข้อมูล</p>
                        </div>
                    <?php endif; ?>
                </div>
            </section>
            ...
            <section class="section">
                <div class="section-header">
                    <div>
                        <h2 class="section-title">
                            <i class="fas fa-document-lines"></i> เธเนเธญเธกเธนเธฅ &amp; เธเธฒเธฃเธงเธดเน€เธเธฃเธฒเธฐเธซเน
                        </h2>
                        <p class="section-subtitle">ภาพรวมแผนภูมิและรายการล่าสุดเพื่อวางแผนทรัพยากร</p>
                    </div>
                    <div class="section-actions">
                        <a class="btn btn-secondary btn-sm" href="tickets.php">
                            <i class="fas fa-arrow-right"></i> ดู Tickets เพิ่มเติม
                        </a>
                    </div>
                </div>
                <div class="section-body">
                    <div class="section-stack">
                        <div class="charts-grid charts-grid--wide">
                            ...
                            <div class="chart-card">
                                <h3 class="chart-title"><i class="fas fa-box"></i> เธชเธ–เธฒเธเธฐเธชเธดเธเธ—เธฃเธฑเธเธขเน</h3>
                            ...
                            <div class="chart-card">
                                <h3 class="chart-title"><i class="fas fa-ticket-alt"></i> เธชเธ–เธฒเธเธฐ Tickets</h3>
                                <div class="chart-container">
                            ...
                            <div class="chart-card">
                                <h3 class="chart-title"><i class="fas fa-flag"></i> เธฅเธณเธ”เธฑเธเธเธงเธฒเธกเธชเธณเธเธฑเธ</h3>
                                <div class="chart-container">
                            ...
                            <div class="chart-card">
                                <h3 class="chart-title"><i class="fas fa-industry"></i> เนเธเธฃเธเธ”เนเธขเธญเธ”เธเธดเธขเธก</h3>
                        ...
                        <div>
                            <div class="section-subheading">
                                <i class="fas fa-list"></i> Tickets เธฅเนเธฒเธชเธธเธ”
                            </div>
                            <div class="card">
                                <div class="card-header">
                                    <h2 class="card-title"><i class="fas fa-history"></i> เธเธฃเธฐเธงเธฑเธ•เธดเธฅเนเธฒเธชเธธเธ”</h2>
                                    <a href="tickets.php">
                                        เธ”เธนเธ—เธฑเนเธเธซเธกเธ” โ’
                                    </a>
                                </div>
                                ...
                                <?php if (empty($recentTickets)): ?>
                                    <div class="card-placeholder">
                                        ...
                                        <p>เธขเธฑเธเนเธกเนเธกเธต Tickets</p>
                                    </div>
                                <?php else: ?>
                                    <?php foreach ($recentTickets as $ticket): ?>
                                        <div class="ticket-item">
                                            ...
                                            <div class="ticket-meta">
                                                ...
                                                |
                                                เธชเธฃเนเธฒเธเนเธ”เธข: <?php echo htmlspecialchars($ticket['creator_name'] ?? 'N/A'); ?>
                                                |
            ...
            <section class="section">
                <div class="section-header">
                    <div>
                        <h2 class="section-title">
                            <i class="fas fa-triangle-exclamation"></i> เธเธฒเธฃเนเธเนเธเน€เธ•เธทเธญเธเนเธฅเธฐเธเนเธญเธกเธนเธฅเธชเธณเธเธฑเธ
                        </h2>
                        <p class="section-subtitle">แจ้งเตือน SLA และทรัพย์สินที่ต้องตอบสนองด่วน</p>
                    </div>
                </div>
                <div class="section-body">
                    <div class="charts-grid charts-grid--wide">
                        ...
                        <div class="chart-card" style="border-top: 4px solid #f56565;">
                            <h3 class="chart-title"><i class="fas fa-exclamation-triangle"></i> Tickets เธ—เธตเนเน€เธเธดเธ SLA (<?php echo count($overdueTickets); ?>)</h3>
                            <ul class="detail-list">
                        ...
                        <div class="chart-card" style="border-top: 4px solid #ed8936;">
                            <h3 class="chart-title"><i class="fas fa-calendar"></i> เธเธฃเธฐเธเธฑเธเธเธฐเธซเธกเธ” 30 เธงเธฑเธ (<?php echo count($warrantyExpiring); ?>)</h3>
                            <ul class="detail-list">
...
<?php ob_start(); ?>
    <script>
        ...
        // โ”€โ”€ Toggle dropdown โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€
        function toggleNotifications() {
            const dropdown = document.getElementById('notificationDropdown');
            dropdown.classList.toggle('show');
        }

        // เธเธดเธ” dropdown เน€เธกเธทเนเธญเธเธฅเธดเธเธเธญเธ (เนเธกเนเธเธดเธ”เธ–เนเธฒเธเธฅเธดเธเธเนเธฒเธเนเธ)
        ...
        // โ”€โ”€ เธเธฅเธดเธ notification เธฃเธฒเธขเธเธฒเธฃ โ’ mark read โ’ เนเธ ticket โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€
        ...
        // โ”€โ”€ เธญเนเธฒเธเธ—เธฑเนเธเธซเธกเธ” โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€
        function markAllRead(btn) {
            // เนเธชเธ”เธ loading เธเธเธเธธเนเธก
            const originalHTML = btn.innerHTML;
            btn.disabled = true;
            btn.innerHTML = '<i class="fas fa-spinner fa-spin"></i> เธเธณเธฅเธฑเธเธญเธฑเธเน€เธ”เธ•...';
            ...
            .then(data => {
                if (data.success) {
                    // โ”€โ”€ เธญเธฑเธเน€เธ”เธ• UI เธ—เธฑเธเธ—เธต เนเธกเนเธ•เนเธญเธ reload โ”€โ”€
                    
                    // 1. เธฅเธ badge เธเธฃเธฐเธ”เธดเนเธ
                    const badge = document.querySelector('.notification-badge');
                    if (badge) badge.remove();

                    // 2. เน€เธญเธฒ highlight เธชเธตเธเนเธฒเธญเธญเธเธเธฒเธเธ—เธธเธ item
                    ...
                    // 3. เธเนเธญเธเธเธธเนเธก "เธญเนเธฒเธเธ—เธฑเนเธเธซเธกเธ”"
                    btn.style.display = 'none';

                    // 4. เนเธชเธ”เธ feedback เธชเธฑเนเธเน
        ...
        // โ”€โ”€ Toast notification โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€
        ...
        // โ”€โ”€ Initialize Charts โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€
        ...
        // โ”€โ”€ Auto-refresh badge เธ—เธธเธ 30 เธงเธดเธเธฒเธ—เธต โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€
